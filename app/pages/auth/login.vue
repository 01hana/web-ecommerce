      ...
      <div class="w-full lg:w-1/2 p-12 lg:p-20 flex flex-col justify-center">
        <div class="login-form-content">
          <header class="mb-10">
            ...
            <h1 class="text-4xl font-serif text-[#1b1b1b]">Login</h1>
          </header>
          ...
          <UForm id="login-form" :state="{}" class="space-y-6">
            ...
            <div class="flex items-center justify-between tracking-wide">
              <label class="flex items-center gap-2 cursor-pointer">
                ...
                <span class="text-gray-500">記住我</span>
              </label>
              <a href="#" class="text-gray-400 hover:text-black transition-colors">忘記密碼？</a>
            </div>
            ...
            <div class="flex items-center justify-center gap-2 tracking-wide">
              還沒有帳號？
              <NuxtLink to="/auth/signup" class="text-gray-400 hover:text-black transition-colors">
                點此註冊
              </NuxtLink>
            </div>
          </UForm>
